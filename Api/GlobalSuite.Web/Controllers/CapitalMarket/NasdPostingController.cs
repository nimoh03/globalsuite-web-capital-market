...
namespace GlobalSuite.Web.Controllers.CapitalMarket
{
    ...
    {
        [HttpPost, Route(GlobalSuiteRoutes.CapitalMarketRoutes.TradingRoutes.NasdPosting)]
        public async Task<IHttpActionResult> PostNasd()
        {
            ...
            file.SaveAs(path);
            var result = await _tradingService.NasdTradePosting(date, path);
