...
{
    public class SelfBalExcelBatchPost
    {
        #region Declaration
        ...
        public SqlCommand SaveCommand()
        {
            ...
            SqlCommand oCommand = db.GetStoredProcCommand("SelfBalExcelBatchPostAdd") as SqlCommand;
        ...
        public DataSet GetAll(DataGeneral.PostStatus TransStatus)
        {
            ...
            {
                dbCommand = db.GetStoredProcCommand("SelfBalExcelBatchPostSelectAllPosted") as SqlCommand;
            }
            else if (TransStatus == DataGeneral.PostStatus.Reversed)
            {
                dbCommand = db.GetStoredProcCommand("SelfBalExcelBatchPostSelectAllReversed") as SqlCommand;
            }
