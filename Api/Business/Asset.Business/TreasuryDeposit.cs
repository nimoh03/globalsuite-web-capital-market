    ...
    public class TreasuryDeposit
    {
            ...
            using (SqlConnection connection = db.CreateConnection() as SqlConnection)
            {
                ...
                try
                {
                    ...
                    if (SaveType == "ADDS")
                    {
                        ...
                        oCommand = db.GetStoredProcCommand("TreasuryDepositAddNew") as SqlCommand;
                        db.AddInParameter(oCommand, "ReceiptNo", SqlDbType.VarChar, strRnumberNext.Trim());
                    }
                    else if (SaveType == "EDIT")
                    {
                        oCommand = db.GetStoredProcCommand("TreasuryDepositEdit") as SqlCommand;
                    }
        ...
        public bool ChkTransNoExist(DataGeneral.PostStatus ePostStatus)
        {
            ...
            if (SaveType == "EDIT")
            {
                ...
                {
                    oCommand = db.GetStoredProcCommand("TreasuryDepositChkTransNoExistUnPosted") as SqlCommand;
                }
                db.AddInParameter(oCommand, "TransNo", SqlDbType.BigInt,TransNo);
        ...
        #region Get
        public bool GetTreasuryDeposit(DataGeneral.PostStatus TranStatus)
        {
            ...
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectUnPost") as SqlCommand;
            }
            else if (TranStatus == DataGeneral.PostStatus.Posted)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectPosted") as SqlCommand;
            }
            else if (TranStatus == DataGeneral.PostStatus.Reversed)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectReversed") as SqlCommand;
            }
            else if (TranStatus == DataGeneral.PostStatus.All)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelect") as SqlCommand;
            }
        ...
        public DataSet GetAll(DataGeneral.PostStatus TransStatus)
        {
            ...
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectAllUnPosted") as SqlCommand;
            }
            else if (TransStatus == DataGeneral.PostStatus.Posted)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectAllPosted") as SqlCommand;
            }
            else if (TransStatus == DataGeneral.PostStatus.Reversed)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectAllReversed") as SqlCommand;
            }
            else if (TransStatus == DataGeneral.PostStatus.UnPostedAsc)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectAllUnPostedAsc") as SqlCommand;
            }
            else if (TransStatus == DataGeneral.PostStatus.PostedAsc)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectAllPostedAsc") as SqlCommand;
            }
            else if (TransStatus == DataGeneral.PostStatus.All)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectAll") as SqlCommand;
            }
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        ...
        public DataSet GetCustomerTreasuryDeposit(DataGeneral.PostStatus TransStatus)
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = null;
            if (TransStatus == DataGeneral.PostStatus.Posted)
            {
                dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectCustomerProductPosted") as SqlCommand;
            }
        ...
        public DataSet GetCustomerTreasuryDepositValid(DateTime datEffDate)
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectCustomerProductValid") as SqlCommand;
            db.AddInParameter(dbCommand, "ProductCode", SqlDbType.Char, ProductCode.Trim());
            db.AddInParameter(dbCommand, "CustomerNo", SqlDbType.NVarChar, CustomerNo.Trim());
        ...
        public DataSet GetCustomerTreasuryDepositRunningForStartDate(DateTime datDateFrom)
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("TreasuryDepositSelectRunningForStartDate") as SqlCommand;
