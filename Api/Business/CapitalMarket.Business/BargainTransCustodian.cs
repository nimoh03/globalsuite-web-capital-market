...
{
    public class BargainTransCustodian
    {
        #region Declaration
        ...
        public bool Add()
        {
            ...
            SqlCommand oCommand = db.GetStoredProcCommand("BargainTransCustodianAddNew") as SqlCommand;
            ...
            db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "BARGAINTRANSCUTSD");
        ...
        public void SaveToBargainSlip()
        {
            ...
            foreach (DataRow oRow in GetUniqueTrans().Tables[0].Rows)
            {
                ...
                oCommand = db.GetStoredProcCommand("BargainSlipCustodianAddNew") as SqlCommand;
                db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
                db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
                db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
                ...
                db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "BARGAINSLIPCUSTODIAN");
                db.ExecuteNonQuery(oCommand);
            }
        }
        #endregion
        ...
        public void SaveToBargainSlipCrossDeal()
        {
            ...
            foreach (DataRow oRow in GetAllBargainTransCrossDeal().Tables[0].Rows)
            {
                ...
                db.AddInParameter(oCommand, "CrossType", SqlDbType.Char, oRow["CrossType"].ToString().Trim());
                db.AddInParameter(oCommand, "CustodianCode", SqlDbType.VarChar, strCustodianCode.Trim());
        ...
        public void SaveToBargainSlipNoProcess()
        {
            ...
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipCustodianAddNew") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
            db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
            db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
            db.AddInParameter(oCommand, "StockCode", SqlDbType.VarChar, strStockCode.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransCustodianGroupByUniqueTransOrderByCustno") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion

        #region Get Double Transaction of the Same Price,Date,Customer Number,Custodian Custodian Code
        public DataSet GetUniqueTransCustodian()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransCustodianGroupByUniqueTransOrderByCustnoCustodian") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        public bool DeleteAll()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransCustodianDeleteAll") as SqlCommand;
        ...
        public void GetBargainTransGivenCustStockPriceTypeCD()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransCustodianSelectByUniqueTransOrderByCustno") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransCustodianSelectAllCrossDeal") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
