...
namespace CapitalMarket.Business
{
    public class BargainTransBank
    {
        ...
        public bool Add()
        {
            ...
            SqlCommand oCommand = db.GetStoredProcCommand("BargainTransBankAddNew") as SqlCommand;
            ...
            db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "BARGAINTRANSBANK");
        ...
        public void SaveToBargainSlip()
        {
            ...
            foreach (DataRow oRow in GetUniqueTrans().Tables[0].Rows)
            {
                ...
                oCommand = db.GetStoredProcCommand("BargainSlipBankAddNew") as SqlCommand;
                db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
                db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
                db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
                ...
                db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "BARGAINSLIPBANK");
                db.ExecuteNonQuery(oCommand);
            }
        }
        #endregion
        ...
        public void SaveToBargainSlipNoProcess()
        {
            ...
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipBankAddNew") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
            db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
            db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
            db.AddInParameter(oCommand, "StockCode", SqlDbType.VarChar, strStockCode.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransBankGroupByUniqueTransOrderByCustno") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransBankGroupByUniqueTransOrderByCustnoBankMargin") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        public bool DeleteAll()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransBankDeleteAll") as SqlCommand;
        ...
        public void GetBargainTransGivenCustStockPriceTypeCD()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransBankSelectByUniqueTransOrderByCustno") as SqlCommand;
        ...
        //{
        //    DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
        //    SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransBankSelectAllCrossDeal") as SqlCommand;
        //    DataSet oDS = db.ExecuteDataSet(dbCommand);
        //    return oDS;
        //}
        //#endregion
