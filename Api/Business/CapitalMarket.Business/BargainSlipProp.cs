...
namespace CapitalMarket.Business
{
    public class BargainSlipProp
    {
        ...
        public DataSet GetAll()
        {
            ...
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropSelectAll") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropDeleteAll") as SqlCommand;
        ...
        public bool UpdateCrossCustNoCsCsAcct()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipPropUpdateCrossCustNoCsCsAcct") as SqlCommand;
        ...
        public bool UpdateUnit()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipPropUpdateUnit") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        public bool Delete()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropDelete") as SqlCommand;
        ...
        public void ProcessCrossDeal()
        {
            ...
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipPropSelectAllBuyCrossDeal") as SqlCommand;
            DataSet oDSBuy = db.ExecuteDataSet(dbCommandBuy);
            foreach (DataRow oRowBuy in oDSBuy.Tables[0].Rows)
            {
                dbCommandSell = db.GetStoredProcCommand("BargainSlipPropSelectSellCrossDealForBuy") as SqlCommand;
        ...
        public void ProcessUnEqualCrossDeal()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommandSell = null;
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipPropSelectNoCrossCustBuyCrossDeal") as SqlCommand;
            DataSet oDSBuy = db.ExecuteDataSet(dbCommandBuy);
            foreach (DataRow oRowBuy in oDSBuy.Tables[0].Rows)
            {
                int intBuyDeducted = 0;
                dbCommandSell = db.GetStoredProcCommand("BargainSlipPropSelectUnEqualSellCrossDealForBuy") as SqlCommand;
                db.AddInParameter(dbCommandSell, "StockCode", SqlDbType.VarChar, oRowBuy["StockCode"].ToString());
                db.AddInParameter(dbCommandSell, "UnitPrice", SqlDbType.Decimal, decimal.Parse(oRowBuy["UnitPrice"].ToString()));
                DataSet oDSSell = db.ExecuteDataSet(dbCommandSell);
                foreach (DataRow oRowSell in oDSSell.Tables[0].Rows)
                {
                    ...
                    {
                        oBargainTransProp.Bslip = oRowBuy["BSlip#"].ToString();
                        oBargainTransProp.iDate = DateTime.ParseExact(oRowBuy["Date"].ToString().Trim().Substring(0, 10), "dd/MM/yyyy", format);
                        oBargainTransProp.StockCode = oRowBuy["StockCode"].ToString();
                        oBargainTransProp.Units = long.Parse(oRowSell["Units"].ToString());
                        oBargainTransProp.UnitPrice = decimal.Parse(oRowSell["UnitPrice"].ToString());
                        oBargainTransProp.Consideration = decimal.Parse(oRowSell["Consideration"].ToString());
                        oBargainTransProp.StockType = oRowBuy["StockType"].ToString();
                        oBargainTransProp.SoldBy = oRowBuy["SoldBy"].ToString();
                        oBargainTransProp.Buy_Sold_Ind = oRowBuy["Buy_Sold_Ind"].ToString();
                        oBargainTransProp.BoughtBy = oRowBuy["BoughtBy"].ToString();
                        oBargainTransProp.CrossD = oRowBuy["CrossD"].ToString();
                        oBargainTransProp.AcctNo = oRowBuy["AcctNo"].ToString();
                        oBargainTransProp.CustNo = oRowBuy["CustNo"].ToString();
                        oBargainTransProp.CrossAcctNo = oRowSell["AcctNo"].ToString();
                        oBargainTransProp.CrossCustNo = oRowSell["CustNo"].ToString();
                        oBargainTransProp.CrossType = "";
                        oBargainTransProp.SaveToBargainSlipPropNoProcess();
                        strTransNo = oRowBuy["TransNo"].ToString();
        ...
        public void ProcessUnEqualSellCrossDeal()
        {
            ...
            SqlCommand dbCommandSell = db.GetStoredProcCommand("BargainSlipPropSelectAllSellCrossDeal") as SqlCommand;
            DataSet oDSSell = db.ExecuteDataSet(dbCommandSell);
            foreach (DataRow oRowSell in oDSSell.Tables[0].Rows)
            {
                int intSellDeducted = 0;
                dbCommandBuy = db.GetStoredProcCommand("BargainSlipPropSelectUnEqualNoCrossCustBuyCrossDealForSell") as SqlCommand;
        ...
        public void UpdateCrossType()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropUpdateCrossType") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipPropDeleteZeroUnitCrossDeal") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropSelectAllCrossDealWithNoCrossCust") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropSelectAllCrossDealWithNegativeUnits") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropSelectAllCrossDeal") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropSelectAllAssetDepositTran") as SqlCommand;
        ...
        public string GetCrossType()
        {
            string strResult = "";
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropSelectCrossType") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        public string UpdateCrossTypeByTransNo()
        {
            string strResult = "";
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropUpdateCrossTypeByTransNo") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropUpdateTreatAsAssetDepositByTransNo") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipPropUpdateChangeToNormalBuyByTransNo") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
            db.ExecuteNonQuery(dbCommand).ToString();
        }
        #endregion
