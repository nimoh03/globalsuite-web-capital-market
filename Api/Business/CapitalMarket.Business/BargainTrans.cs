...
namespace CapitalMarket.Business
{
    public class BargainTrans
    {
        ...
        public void Add()
        {
            ...
            SqlCommand oCommand = db.GetStoredProcCommand("BargainTransAddNew") as SqlCommand;
            ...
            db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "BARGAINTRANS");
            db.ExecuteNonQuery(oCommand);
        }
        #endregion

        
        #region Save To BargainSlip
        public void SaveToBargainSlip()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            ...
            foreach (DataRow oRow in GetUniqueTrans().Tables[0].Rows)
            {
                ...
                GetBargainTransGivenCustStockPriceTypeCD();
                oCommand = db.GetStoredProcCommand("BargainSlipAddNew") as SqlCommand;
                db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
                db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
                db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
        ...
        #region Save To BargainSlip Cross Deal
        public void SaveToBargainSlipCrossDeal()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = null;
            foreach (DataRow oRow in GetAllBargainTransCrossDeal().Tables[0].Rows)
            {
                oCommand = db.GetStoredProcCommand("BargainSlipAddNew") as SqlCommand;
        ...
        #region Save To BargainSlip No Process
        public void SaveToBargainSlipNoProcess()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;

            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipAddNew") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
            db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
            db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
            db.AddInParameter(oCommand, "StockCode", SqlDbType.VarChar, strStockCode.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransGroupByUniqueTransOrderByCustno") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransGroupByUniqueTransOrderByCustnoBankMargin") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransDeleteAll") as SqlCommand;
            db.ExecuteNonQuery(dbCommand);
        }
        #endregion

        #region Get A Bargain Trans Info Given CustNo,Stock,Price,BuySell Type,Cross Deal
        public void GetBargainTransGivenCustStockPriceTypeCD()
        {
            System.Threading.Thread.CurrentThread.CurrentCulture = new CultureInfo("en-GB");
            IFormatProvider format = new CultureInfo("en-GB");
            string strAllBargainSlip = "";
            int intNumberOfTransaction = 0;
            int intCounter = 0;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransSelectByUniqueTransOrderByCustno") as SqlCommand;
            ...
            {
                strAllBargainSlip = strAllBargainSlip + oRowTicketNumber["Bslip#"].ToString().Trim();
                intCounter = intCounter + 1;
                if (intCounter < intNumberOfTransaction)
                {
                    strAllBargainSlip = strAllBargainSlip + @"; ";
                }
            }
        ...
        public DataSet GetAllBargainTransCrossDeal()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransSelectAllCrossDeal") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
