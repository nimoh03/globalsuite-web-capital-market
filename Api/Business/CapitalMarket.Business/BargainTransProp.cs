...
namespace CapitalMarket.Business
{
    public class BargainTransProp
    {
        ...
        public void Add()
        {
            ...
            SqlCommand oCommand = db.GetStoredProcCommand("BargainTransPropAddNew") as SqlCommand;
            ...
            db.AddInParameter(oCommand, "AcctNo", SqlDbType.VarChar, strAcctNo.Trim());
            db.AddInParameter(oCommand, "CrossAcctNo", SqlDbType.VarChar, strCrossAcctNo);
            ...
            db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "BargainTransProp");
            db.ExecuteNonQuery(oCommand);
        }
        #endregion


        #region Save To BargainSlipProp
        public void SaveToBargainSlipProp()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            ...
            foreach (DataRow oRow in GetUniqueTrans().Tables[0].Rows)
            {
                ...
                GetBargainTransPropGivenCustStockPriceTypeCD();
                oCommand = db.GetStoredProcCommand("BargainSlipPropAddNew") as SqlCommand;
                db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
                db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
                db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
                ...
                db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "BargainSlipProp");
                db.ExecuteNonQuery(oCommand);
            }
        }
        #endregion

        #region Save To BargainSlipProp Cross Deal
        public void SaveToBargainSlipPropCrossDeal()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = null;
            foreach (DataRow oRow in GetAllBargainTransPropCrossDeal().Tables[0].Rows)
            {
                oCommand = db.GetStoredProcCommand("BargainSlipPropAddNew") as SqlCommand;
                ...
                db.AddInParameter(oCommand, "StockCode", SqlDbType.VarChar, oRow["StockCode"].ToString().Trim());
                db.AddInParameter(oCommand, "Units", SqlDbType.BigInt, long.Parse(oRow["Units"].ToString()));
                db.AddInParameter(oCommand, "Unitprice", SqlDbType.Money, decimal.Parse(oRow["UnitPrice"].ToString()));
                ...
                db.AddInParameter(oCommand, "AcctNo", SqlDbType.VarChar, oRow["AcctNo"].ToString().Trim());
                db.AddInParameter(oCommand, "CrossAcctNo", SqlDbType.VarChar, oRow["CrossAcctNo"].ToString().Trim());
                db.AddInParameter(oCommand, "CustNo", SqlDbType.VarChar, oRow["CustNo"].ToString().Trim());
        ...
        #region Save To BargainSlipProp No Process
        public void SaveToBargainSlipPropNoProcess()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;

            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipPropAddNew") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo);
            db.AddInParameter(oCommand, "Date", SqlDbType.DateTime, datiDate);
            db.AddInParameter(oCommand, "Bslip", SqlDbType.VarChar, strBslip.Trim());
            db.AddInParameter(oCommand, "StockCode", SqlDbType.VarChar, strStockCode.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransPropGroupByUniqueTransOrderByCustno") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransPropGroupByUniqueTransOrderByCustnoBankMargin") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransPropDeleteAll") as SqlCommand;
            db.ExecuteNonQuery(dbCommand);
        }
        #endregion

        #region Get A Bargain Trans Info Given CustNo,Stock,Price,BuySell Type,Cross Deal
        public void GetBargainTransPropGivenCustStockPriceTypeCD()
        {
            System.Threading.Thread.CurrentThread.CurrentCulture = new CultureInfo("en-GB");
            IFormatProvider format = new CultureInfo("en-GB");
            string strAllBargainSlipProp = "";
            int intNumberOfTransaction = 0;
            int intCounter = 0;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransPropSelectByUniqueTransOrderByCustno") as SqlCommand;
            ...
            intNumberOfTransaction = oDS.Tables[0].Rows.Count;
            foreach (DataRow oRowTicketNumber in oDS.Tables[0].Rows)
            {
                strAllBargainSlipProp = strAllBargainSlipProp + oRowTicketNumber["Bslip#"].ToString().Trim();
                intCounter = intCounter + 1;
                if (intCounter < intNumberOfTransaction)
                {
                    strAllBargainSlipProp = strAllBargainSlipProp + @"; ";
                }
            }
            ...
            if (thisRow.Length >= 1)
            {
                ...
                strBslip = strAllBargainSlipProp;
                strStockCode = thisRow[0]["StockCode"].ToString();
                intUnits = long.Parse(thisRow[0]["Units"].ToString());
                ...
                strAcctNo = thisRow[0]["AcctNo"].ToString();
            }
            else
            {
                throw new Exception();
        ...
        public DataSet GetAllBargainTransPropCrossDeal()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainTransPropSelectAllCrossDeal") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
