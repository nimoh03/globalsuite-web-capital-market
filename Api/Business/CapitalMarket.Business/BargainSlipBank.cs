...
namespace CapitalMarket.Business
{
    public class BargainSlipBank
    {
        ...
        public DataSet GetAll()
        {
            ...
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipBankSelectAll") as SqlCommand;
        ...
        public bool DeleteAll()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipBankDeleteAll") as SqlCommand;
        ...
        public bool UpdateCrossCustNoCsCsAcct()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipBankUpdateCrossCustNoCsCsAcct") as SqlCommand;
        ...
        public bool UpdateUnit()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipBankUpdateUnit") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        public bool Delete()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipBankDelete") as SqlCommand;
        ...
        public void ProcessCrossDeal()
        {
            ...
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipBankSelectAllBuyCrossDeal") as SqlCommand;
            DataSet oDSBuy = db.ExecuteDataSet(dbCommandBuy);
            foreach (DataRow oRowBuy in oDSBuy.Tables[0].Rows)
            {
                dbCommandSell = db.GetStoredProcCommand("BargainSlipBankSelectSellCrossDealForBuy") as SqlCommand;
        ...
        public void ProcessUnEqualCrossDeal()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommandSell = null;
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipBankSelectNoCrossCustBuyCrossDeal") as SqlCommand;
            DataSet oDSBuy = db.ExecuteDataSet(dbCommandBuy);
            foreach (DataRow oRowBuy in oDSBuy.Tables[0].Rows)
            {
                int intBuyDeducted = 0;

                dbCommandSell = db.GetStoredProcCommand("BargainSlipBankSelectUnEqualSellCrossDealForBuy") as SqlCommand;
                db.AddInParameter(dbCommandSell, "StockCode", SqlDbType.VarChar, oRowBuy["StockCode"].ToString());
                db.AddInParameter(dbCommandSell, "UnitPrice", SqlDbType.Decimal, decimal.Parse(oRowBuy["UnitPrice"].ToString()));
                DataSet oDSSell = db.ExecuteDataSet(dbCommandSell);
        ...
        public void ProcessUnEqualSellCrossDeal()
        {
            ...
            SqlCommand dbCommandSell = db.GetStoredProcCommand("BargainSlipBankSelectAllSellCrossDeal") as SqlCommand;
            DataSet oDSSell = db.ExecuteDataSet(dbCommandSell);
            foreach (DataRow oRowSell in oDSSell.Tables[0].Rows)
            {
                int intSellDeducted = 0;
                dbCommandBuy = db.GetStoredProcCommand("BargainSlipBankSelectUnEqualNoCrossCustBuyCrossDealForSell") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipBankDeleteZeroUnitCrossDeal") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipBankSelectAllCrossDealWithNoCrossCust") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipBankSelectAllCrossDealWithNegativeUnits") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipBankSelectAllCrossDeal") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        public bool UpdateOrdCross()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipBankUpdateOrdCross") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
            db.ExecuteNonQuery(oCommand);
            blnStatus = true;
