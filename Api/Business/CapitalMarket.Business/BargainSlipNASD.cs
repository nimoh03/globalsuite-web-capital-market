...
namespace CapitalMarket.Business
{
    public class BargainSlipNASD
    {
        ...
        public DataSet GetAll()
        {
            ...
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDSelectAll") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDDeleteAll") as SqlCommand;
        ...
        public bool UpdateCrossCustNoCsCsAcct()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipNASDUpdateCrossCustNoCsCsAcct") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
            db.AddInParameter(oCommand, "CrossAcctNo", SqlDbType.VarChar, strCrossNASDAcctNo.Trim());
        ...
        public bool UpdateUnit()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand oCommand = db.GetStoredProcCommand("BargainSlipNASDUpdateUnit") as SqlCommand;
            db.AddInParameter(oCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        public bool Delete()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDDelete") as SqlCommand;
        ...
        public void ProcessCrossDeal()
        {
            ...
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipNASDSelectAllBuyCrossDeal") as SqlCommand;
            DataSet oDSBuy = db.ExecuteDataSet(dbCommandBuy);
            foreach (DataRow oRowBuy in oDSBuy.Tables[0].Rows)
            {
                dbCommandSell = db.GetStoredProcCommand("BargainSlipNASDSelectSellCrossDealForBuy") as SqlCommand;
                ...
                if (thisRowSell.Length >= 1)
                {
                    ...
                    strCrossNASDAcctNo = thisRowSell[0]["NASDAcctNo"].ToString();
        ...
        public void ProcessUnEqualCrossDeal()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommandSell = null;
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipNASDSelectNoCrossCustBuyCrossDeal") as SqlCommand;
            DataSet oDSBuy = db.ExecuteDataSet(dbCommandBuy);
            foreach (DataRow oRowBuy in oDSBuy.Tables[0].Rows)
            {
                int intBuyDeducted = 0;
                dbCommandSell = db.GetStoredProcCommand("BargainSlipNASDSelectUnEqualSellCrossDealForBuy") as SqlCommand;
                db.AddInParameter(dbCommandSell, "StockCode", SqlDbType.VarChar, oRowBuy["StockCode"].ToString());
                db.AddInParameter(dbCommandSell, "UnitPrice", SqlDbType.Decimal, decimal.Parse(oRowBuy["UnitPrice"].ToString()));
                DataSet oDSSell = db.ExecuteDataSet(dbCommandSell);
                foreach (DataRow oRowSell in oDSSell.Tables[0].Rows)
                {
                    ...
                    {
                        oBargainTransNASD.Bslip = oRowBuy["BSlip#"].ToString();
                        oBargainTransNASD.iDate = DateTime.ParseExact(oRowBuy["Date"].ToString().Trim().Substring(0, 10), "dd/MM/yyyy", format);
                        oBargainTransNASD.StockCode = oRowBuy["StockCode"].ToString();
                        oBargainTransNASD.Units = int.Parse(oRowSell["Units"].ToString());
                        oBargainTransNASD.UnitPrice = decimal.Parse(oRowSell["UnitPrice"].ToString());
                        oBargainTransNASD.Consideration = decimal.Parse(oRowSell["Consideration"].ToString());
                        oBargainTransNASD.StockType = oRowBuy["StockType"].ToString();
                        oBargainTransNASD.SoldBy = oRowBuy["SoldBy"].ToString();
                        oBargainTransNASD.Buy_Sold_Ind = oRowBuy["Buy_Sold_Ind"].ToString();
                        oBargainTransNASD.BoughtBy = oRowBuy["BoughtBy"].ToString();
                        oBargainTransNASD.CrossD = oRowBuy["CrossD"].ToString();
                        oBargainTransNASD.NASDAcctNo = oRowBuy["NASDAcctNo"].ToString();
                        oBargainTransNASD.CustNo = oRowBuy["CustNo"].ToString();
                        oBargainTransNASD.CrossNASDAcctNo = oRowSell["NASDAcctNo"].ToString();
                        oBargainTransNASD.CrossCustNo = oRowSell["CustNo"].ToString();
                        oBargainTransNASD.CrossType = "";
                        oBargainTransNASD.SaveToBargainSlipNASDNoProcess();
                        strTransNo = oRowBuy["TransNo"].ToString();
        ...
        public void ProcessUnEqualSellCrossDeal()
        {
            ...
            SqlCommand dbCommandSell = db.GetStoredProcCommand("BargainSlipNASDSelectAllSellCrossDeal") as SqlCommand;
            DataSet oDSSell = db.ExecuteDataSet(dbCommandSell);
            foreach (DataRow oRowSell in oDSSell.Tables[0].Rows)
            {
                int intSellDeducted = 0;
                dbCommandBuy = db.GetStoredProcCommand("BargainSlipNASDSelectUnEqualNoCrossCustBuyCrossDealForSell") as SqlCommand;
                ...
                foreach (DataRow oRowBuy in oDSBuy.Tables[0].Rows)
                {
                    if ((int.Parse(oRowSell["Units"].ToString()) - intSellDeducted) > int.Parse(oRowBuy["Units"].ToString()))
                    {
                        ...
                        strCrossNASDAcctNo = oRowSell["NASDAcctNo"].ToString();
                        UpdateCrossCustNoCsCsAcct();
                        strTransNo = oRowSell["TransNo"].ToString();
        ...
        public void UpdateCrossType()
        {
            ...
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDUpdateCrossType") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommandBuy = db.GetStoredProcCommand("BargainSlipNASDDeleteZeroUnitCrossDeal") as SqlCommand;
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDSelectAllCrossDealWithNoCrossCust") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDSelectAllCrossDealWithNegativeUnits") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDSelectAllCrossDeal") as SqlCommand;
            DataSet oDS = db.ExecuteDataSet(dbCommand);
            return oDS;
        }
        #endregion
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDSelectAllAssetDepositTran") as SqlCommand;
        ...
        public string GetCrossType()
        {
            string strResult = "";
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDSelectCrossType") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        public string UpdateCrossTypeByTransNo()
        {
            string strResult = "";
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDUpdateCrossTypeByTransNo") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDUpdateTreatAsAssetDepositByTransNo") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
        ...
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("BargainSlipNASDUpdateChangeToNormalBuyByTransNo") as SqlCommand;
            db.AddInParameter(dbCommand, "TransNo", SqlDbType.VarChar, strTransNo.Trim());
            db.ExecuteNonQuery(dbCommand).ToString();
        }
        #endregion
