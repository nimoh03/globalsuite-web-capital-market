...
namespace Admin.Business
{
    public class UserLevelProfile
    {
        ...
        //Customers
        private bool blnCustRecAcc, blnCustActivat, blnCustDeactivat, blnScanPict,blnCustomerModify, blnAccessAcctIncompleteKYC, blnDelCustTrans;
        ...
        private string strUserLevelName ;
        #endregion
        ...
        #region Transaction
                ...
                {
                    set { strUserLevelName  = value; }
                    get { return strUserLevelName ; }
                }
                public bool BackUp
                {
                    set { blnBackUp = value; }
        ...
        public bool GetUserLevelProfile()
        {
            IFormatProvider format = new CultureInfo("en-GB");
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("UserLevelProfileSelect") as SqlCommand;
            db.AddInParameter(dbCommand, "UserLevelName", SqlDbType.VarChar, strUserLevelName.Trim());
            ...
            if (thisRow.Length == 1)
            {
                ...
                blnAccessAcctIncompleteKYC = bool.Parse(thisRow[0]["AccessAcctIncompleteKYC"].ToString() != "" ? thisRow[0]["AccessAcctIncompleteKYC"].ToString() : "false");
        ...
        public DataGeneral.SaveStatus Save()
        {
            ...
            using (SqlConnection connection = db.CreateConnection() as SqlConnection)
            {
                ...
                try
                {
                    ...
                    if (ChkUserLevelProfileExist())
                    {
                        oCommand = db.GetStoredProcCommand("UserLevelProfileEdit") as SqlCommand;
                    }
                    else
                    {
                        oCommand = db.GetStoredProcCommand("UserLevelProfileAddNew") as SqlCommand;
                    }
                    db.AddInParameter(oCommand, "UserLevelName", SqlDbType.VarChar, strUserLevelName.Trim());
        ...
        public bool ChkUserLevelProfileExist()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("UserLevelProfileSelect") as SqlCommand;
