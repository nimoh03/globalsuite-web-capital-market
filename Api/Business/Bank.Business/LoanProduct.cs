...
namespace Bank.Business
{
    public class LoanProduct
    {
        ...
        public DataGeneral.SaveStatus Save()
        {
            ...
            if (SaveType == "ADDS")
            {
                oCommand = db.GetStoredProcCommand("LoanProductAddNew") as SqlCommand;
                db.AddInParameter(oCommand, "TableName", SqlDbType.VarChar, "PRODUCT");
            }
            else if (SaveType == "EDIT")
            {
                oCommand = db.GetStoredProcCommand("LoanProductEdit") as SqlCommand;
            }
        ...
        public bool ChkTransNoExist()
        {
            ...
            {
                DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
                SqlCommand oCommand = db.GetStoredProcCommand("LoanProductChkTransNoExist") as SqlCommand;
        ...
        #region Get
        public bool GetLoanProduct()
        {
            bool blnStatus = false;
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("LoanProductSelect") as SqlCommand;
        ...
        public DataSet GetAll()
        {
            ...
            dbCommand = db.GetStoredProcCommand("LoanProductSelectAll") as SqlCommand;
        ...
        public string GetLoanProductGLAccount()
        {
            DatabaseProviderFactory factory = new DatabaseProviderFactory(); SqlDatabase db = factory.Create("GlobalSuitedb") as SqlDatabase;
            SqlCommand dbCommand = db.GetStoredProcCommand("LoanProductSelectGLAccount") as SqlCommand;
