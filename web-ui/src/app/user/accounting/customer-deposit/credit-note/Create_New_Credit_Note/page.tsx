...
return ({
  ...
  const handleSubmit = async () => {
    ...
    if (await form.validateFields({ validateOnly: true })) {
      setIsModalOpen(false);
      setIsLoading(true);
      const response = await depositStore.createNewCreditNote({
        ...values,
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3">
              <Form.Item
                name={"acctSubBank"}
                className="mb-3 flex-1"
                label={<p className="font-[600] leading-[20px] text-[16px]">Account To Debit</p>}
                rules={[{ required: true }]}
              >
                <Select
                  showSearch
              ...
              <Form.Item
                name={"ref"}
                className="mb-3 flex-1"
                label={<p className="font-[600] leading-[20px] text-[16px] ">Reference</p>}
                rules={[{ required: true }]}
              >
            ...
            label={<p className="font-[600] leading-[20px] text-[16px] ">Amount Paid</p>}
                rules={[{ required: true , message: 'Make Sure the Amount is Greater Than the balance'}]}
              >
            ...
            {/* <div className="flex gap-3">
              <Form.Item
                name={"instrumentType"}
                className="mb-3 flex-1"
                label={<p className="font-[600] leading-[20px] text-[16px] ">Paying Instrument</p>}
                rules={[{ required: true }]}
              >
                <Select
                  showSearch
              ...
              {PaymentInstrumentValue !== 0 || values?.instrumentType !== 0 ? (
                <Form.Item
                  name={"ChqueNo"}
                  className="mb-3 "
                  label={<p className="font-[600] leading-[20px] text-[16px] ">Cheque No</p>}
                >
              ...
              <Form.Item
                className="mb-3 flex-1"
                label={<p className="font-[600] leading-[20px] text-[16px] ">Customer Branch</p>}
                // rules={[{ required: true }]}
              >
                <Select
...
//className = '!bg-[#194BFB] text-[white] font-[600] '
        ...
        >
          <div className="w-[80%] mx-auto justify-center items-center text-center mt-8 gap-5">
            ...
            <Image src={images.warningModalImage} alt="warning_Modal_Image" className="object-cover " />
