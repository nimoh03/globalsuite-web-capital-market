...
export default observer(function Page({
  ...
  const fetch = async () => {
    const fetchTransactionDetails = await depositStore.getOpeningBalanceByCode(
      params.payment_Details.toString(),depositStore.openingBalStatus || localStorage.getItem('openingBalStatus')
    );
