  ...
  return (
    <>
        ...
        <div className="p-2  w-full">
          <div className="rounded-xl overflow-hidden border shadow">
            <h4 className="bg-blue-300 text-white h-10 flex items-center pl-5 text-base">
              <PaperClipOutlined />
              Add/Deduct Stock Portfolio Holding Detail
            </h4>
            <div className="p-2 w-full">
              <Descriptions
                bordered
              ...
              <div className="my-3">
                <Radio.Group name="radiogroup">
                  <Radio value='Add To Portfolio'>Add To Portfolio</Radio>
                  <Radio value='Deduct From Portfolio'>Deduct From Portfolio</Radio>
                </Radio.Group>
              </div>
              <h5 className="text-green-200 text-xs my-5">
              ...
              <div className="flex justify-between px-2">
                ...
                <Button
                  ...
                  >
                    View Unapproved Add/Deduct Portfolio Holding Balance
                  </Button>
                <Button
                    htmlType="submit"
                    className="text-base bg-gray-100 text-blue-200 border-none"
      ...
      <div className="flex justify-between px-5 mb-5">
        ...
        <Button className="bg-red-250 text-green-200 border-bone">
          Approved
        </Button>
      </div>
    </>
