      ...
      render: () => (
        <div className="flex justify-center items-center gap-4">
          ...
          <Tooltip placement="bottom" title="edit">
            <Link
              href="/user/capital-market/portfolio-management/Add-Or-Deduct-Portfolio-Holding-Balance/edit"
              className=""
            >
              <Image
    ...
    <>
      <div className=" flex overflow-auto gap-3 lg:justify-end lg:gap-7 my-5 lg:pr-5">
        ...
        <Button className="text-blue-200 text-base bg-gray-100 border-none">
          <Link href="/user/capital-market/portfolio-management/Add-Or-Deduct-Portfolio-Holding-Balance/reverse">
            View Reversed Holdings
          </Link>
        </Button>
        <Button className="text-blue-200 text-base bg-gray-100 border-none">
          <Link href="/user/capital-market/portfolio-management/Add-Or-Deduct-Portfolio-Holding-Balance/detail">
            View Approved Holdings
          </Link>
        </Button>
        <Button className="text-white text-base bg-blue-200">
          <Link href="/user/capital-market/portfolio-management/Add-Or-Deduct-Portfolio-Holding-Balance/new">
            Add New Holdings
          </Link>
        </Button>
      </div>
      <div className="rounded-lg shadow-xl w-full ">
        <div className={manrope.className}>
          <p className="flex justify-start gap-2 items-center text-base px-5 w-full capitalize bg-[#194bfb] text-white rounded-t-lg h-10">
            ...
            Unapproved Add/Deduct Stock Portfolio Holding
          </p>
          <Table
           size="small"
