        ...
        >
          ...
          <div className="p-5 mt-5 mb-11 ">
            ...
            <div className="w-full md:w-1/4 mx-auto flex justify-around md:justify-between my-2">
              <Button className="bg-red-250 text-red-150 text-base border-none">Cancel</Button>
              <Button className="bg-blue-200 text-white border-none">Post</Button>
            </div>
