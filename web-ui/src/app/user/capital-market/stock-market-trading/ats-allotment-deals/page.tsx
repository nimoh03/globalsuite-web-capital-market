      ...
      render: () => (
        <div className="flex justify-center items-center gap-4">
          ...
          <Tooltip placement="bottom" title="edit">
            <Link
              href="/user/capital-market/stock-market-trading/ats-allotment-deals/purchase/edit"
              className=""
            >
              <Image
  ...
  return (
    ...
    <div className=" flex overflow-auto gap-3 lg:justify-end lg:gap-3 my-5 lg:pr-3">
        ...
        <Button className="text-blue-200 text-base bg-gray-100 border-none font-bold">
          View Reversed Purchase
        </Button>
        <Button className="text-blue-200 text-base bg-gray-100 border-none font-bold">
          <Link href="/user/capital-market/stock-market-trading/ats-allotment-deals/purchase/detail">
            View Approved Purchase
          </Link>
        </Button>
        <Button className="text-white text-base bg-blue-200 font-bold">
          <Link href="/user/capital-market/stock-market-trading/ats-allotment-deals/purchase/new">
            Add New Purchse
          </Link>
        </Button>
      </div>
