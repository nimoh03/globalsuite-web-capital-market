...
const Page = () => {
  ...
  return (
    <div className=" m-4 overflow-hidden border shadow rounded-lg">
      ...
      <div className="p-2 bg-gray-50">
        <Form className="p-4">
          ...
          <div className="flex flex-col md:flex md:justify-between md:flex-row gap-5 ">
            <div>
            <Button className=" bg-blue-200 text-white border-none font-bold">View Unapproved Purchase Trades</Button>
            </div>
            <div>
            <Button htmlType="reset" className="bg-red-250 text-red-150 text-base border-none mx-1 md:mx-5 font-bold">Cancel</Button>
            <Button htmlType="submit" className=" bg-blue-200 text-white border-none font-bold">Save</Button>
            </div>
