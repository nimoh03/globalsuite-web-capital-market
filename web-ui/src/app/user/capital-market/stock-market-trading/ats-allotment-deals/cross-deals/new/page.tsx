...
const Page = () => {
 ...
 <div className="rounded-xl m-4 overflow-hidden border shadow bg-gray-50">
      <h4 className="text-base bg-blue-200 h-10 flex items-center text-white pl-5">
        Cross Deal Trades / Deals - New
      </h4>
      <div className="px-3 py-5 form-bg">
        <Form>
        ...
        <h4 className="text-base bg-blue-200 h-10 flex items-center text-white pl-5 rounded-t-xl" style={{textAlign:'center'}}>
      ...
      <div className="grid md:grid-cols-5 gap-5 py-5">
            ...
            <div className="col-span-1">
              <span className="block text-base">COMMISION</span>
      ...
      <div className="grid md:grid-cols-5 gap-5 py-5">
        ...
        <div className="flex">
          ...
          <div className="flex flex-col md:flex-row md:justify-between gap-5">
            <div>
            <Button  className=" bg-blue-200 text-white border-none">View Unapproved Cross Deals</Button>
            </div>
            <div>
            <Button htmlType="reset"className="bg-red-250 text-red-150 text-base border-none mx-1 md:mx-5">Cancel</Button>
            <Button htmlType="submit"className=" bg-blue-200 text-white border-none">Submit</Button>
            </div>
