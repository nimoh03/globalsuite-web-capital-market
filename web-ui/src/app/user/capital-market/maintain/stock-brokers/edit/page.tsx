      ...
      <main className="flex min-h-screen flex-col items-center p-5 gap-16">
        <div className="border rounded-xl shadow w-full bg-gray-50">
          <h4 className="flex justify-start items-center text-base px-10 w-full capitalize bg-[#194bfb] text-white rounded-t-xl h-10">
            StockBroking Firm - Edit
          </h4>
          <div className="p-5">
            <div className="grid lg:grid-cols-3">
              <div className="col-span-1">
              <span className="block text-base font-semibold">Transaction number</span>
              <Select
                defaultValue="lucy"
                style={{
                  width: "100%",
            ...
            <div className="grid lg:grid-cols-3 gap-5 my-3">
              <div className="col-span-1">
                <span className="block text-base font-semibold">StockBroker Code</span>
                <Input placeholder="Reference" />
              </div>
              <div className="col-span-2">
                <span className="block text-base font-semibold">StockBroker Name</span>
                <Input placeholder="Reference" />
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-5 my-5">
              <div className="col-span-1">
                <span className="block text-base font-semibold">Telephone</span>
                <Input placeholder="Reference" />
              </div>
              <div className="col-span-1">
                <span className="block text-base font-semibold">Fax</span>
                <Input placeholder="Reference" />
              </div>
              <div className="col-span-1">
