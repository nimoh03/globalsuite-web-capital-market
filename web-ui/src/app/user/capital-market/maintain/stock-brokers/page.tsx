...
export default observer(function AccountingCustomerDepositCreditNote() {
  ...
  const columns: ColumnsType<DataType> = [
    {
      title: <p className="font-bold text-base leading-6">Broker Code</p>,
      dataIndex: "broker code",
      align: "center",
      render: (text) => (
    ...
    {
      title: <p className="font-bold text-base leading-6">Broker Name</p>,
    ...
    {
      title: <p className="font-bold text-base leading-6">Address</p>,
      dataIndex: "address",
      align: "center",
      render: (text) => (
        <p className="font-medium text-sm leading-5" >{text}</p>
    ...
    {
      title: <p className="font-bold text-base leading-6">Phone No.</p>,
      dataIndex: "phone no",
      align: "center",
    },
    {
      ...
      render: () => (
        <div className="flex justify-center items-center gap-4">
          ...
          <Tooltip placement="bottom" title="edit">
            <Link href='/user/capital-market/maintain/stock-brokers/edit' className="">
            <Image
     ...
     <div className="flex justify-between px-5 my-5" >
       ...
       <Select
        ...
        <Button className="text-white text-base bg-blue-200">
          <Link href='/user/capital-market/maintain/stock-brokers/new'>
          Add New StockBrokers
          </Link>
