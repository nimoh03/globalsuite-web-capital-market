      ...
      <main className="min-h-screen m-2 ">
        <Form className="rounded-xl border overflow-hidden mx-auto shadow-sm bg-gray-50">
          <h4 className="bg-blue-600 p-2 pl-10 text-white text-base">
            <PaperClipOutlined />
            Merge Customer StockBroking Account - Edit
          </h4>
        ...
        <div className=" w-full md:w-3/5 mx-auto  my-10">
        <p className="text-base text-gray-500 my-5 font-semibold">Account To Be Merged</p>
        <Table
            className="rounded-xl border"
            scroll={{ x: "max-content" }}
            rowSelection={{
        ...
        <div className="flex lg:justify-center gap-3 overflow-auto">
