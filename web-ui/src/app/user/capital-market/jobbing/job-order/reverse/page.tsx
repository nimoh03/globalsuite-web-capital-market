...
const items = [
  {
    ...
    children: <p className="text-base font-bold leading-6">00192NCJA</p>,
  },
  {
    label: (
      <div className="flex items-center gap-3">
  ...
  return (
    <div className={manrope.className}>
      ...
      <div className="flex justify-between px-10 my-5">
          ...
          <Button className="text-green-200 border-none bg-red-250">Approved</Button>
      </div>
      </div>
